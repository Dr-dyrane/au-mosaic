  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        when: "desk",
        title: "The filters",
        line: "All, Tiles, Materials, Running low: one tap narrows the shelf, and the URL remembers.",
      },
      {
        sel: "[data-tour='stock-hues']",
        when: "desk",
        title: "The hue dots",
        line: "Colour the way a customer says it: blues, greens, earths, neutrals.",
      },
      {
        sel: "[data-tour='stock-sorts']",
        when: "desk",
        title: "The sorts",
        line: "By name to find fast, Low first to write the reorder list.",
      },
      {
        ...
        kind: "do",
        title: "The filter",
        line: "Tap Filter and the sheet rises under your thumb.",
      },
      {
        sel: "[data-tour='stock-sheet']",
        when: "phone",
        title: "The sheet",
        line: "Families, Running low, the hue rows, and Order by, each row a full thumb.",
      },
      {
        ...
        kind: "do",
        title: "Put it away",
        line: "Tap the cross to close the sheet.",
      },
      {
